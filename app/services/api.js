...
//     console.log('🟢 [Frontend-Website] Request:', config.method.toUpperCase(), config.url);
//     console.log('🟢 [Frontend-Website] Token:', token ? '✅ Found' : '❌ Not found');
//     if (token) {
//       config.headers.Authorization = `Bearer ${token}`;
//       console.log('🟢 [Frontend-Website] Token Header Set ✅');
//     }
//     return config;
//   },
...
//   (response) => {
//     console.log('🟢 [Frontend-Website] Response:', response.status, response.data);
//     return response;
//   },
//   (error) => {
//     console.error('🔴 [Frontend-Website] Error:', error.response?.data || error.message);
...
//   likeImage: (imageId) =>
//     api.post(`/images/${imageId}/like`,{withCredentials: true}),
//   unlikeImage: (imageId) =>
