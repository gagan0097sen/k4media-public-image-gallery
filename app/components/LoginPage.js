...
//         <h1 className={styles.title}>🖼️ Image Gallery</h1>
//         <p className={styles.subtitle}>Beautiful moments, shared stories</p>
        
//         <div className={styles.content}>
//           {/* <p className={styles.description}>
//             Login to discover amazing images, like your favorites, and see what others love.
//           </p> */}
...
//             Your privacy matters. We only use your login to personalize your experience.
//           </p>
//         </div>
//       </div>
//     </div>
