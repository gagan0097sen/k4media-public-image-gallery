...
//       if (err.response?.status !== 400) { // Don't show error if already liked
//         setError(errorMsg);
//       }
//     }
//   };
...
//       if (err.response?.status !== 400) { // Don't show error if not liked
//         setError(errorMsg);
//       }
//     }
//   };
...
//             ℹ️ Login to like and manage your favorite images
//           </div>
//         )}
